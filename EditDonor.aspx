<%@ Page Title="Edit Donor Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="EditDonor.aspx.cs" CodeBehind="EditDonor.aspx.cs" Inherits="ShareLife.EditDonor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlNotLoggedIn" runat="server" Visible="false">
        <div class="content-card" style="text-align:center; padding: 3rem;">
            ...
            <p class="page-subtitle" style="margin-top:0.5rem;">You must be logged in to edit blood donor records.</p>
    ...
    <div class="content-card">
        <h2 class="page-title">Edit Donor Record</h2>
        <p class="page-subtitle">Update personal details and medical information for registered donor #<asp:Literal ID="litDonorIDHeader" runat="server" />.</p>

        <asp:Panel ID="pnlMessage" runat="server" Visible="false">
            <asp:Label ID="lblMessage" runat="server"></asp:Label>
        </asp:Panel>

        <asp:Panel ID="pnlNotFound" runat="server" Visible="false" CssClass="alert-message alert-danger">
            <p>Donor record not found. <a href="ViewDonors.aspx" style="color:var(--primary-color); font-weight:bold;">Return to Donor Directory</a>.</p>
        </asp:Panel>
        ...
        <asp:Panel ID="pnlEditForm" runat="server">
            ...
            <div class="form-section">
                <h3 class="form-section-title"><span class="section-icon">&#9877;</span> Medical Details</h3>
                <div class="form-grid">
                    <!-- Blood Group -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtLastDonationDate" runat="server" CssClass="form-control" TextMode="Date" placeholder="Select date"></asp:TextBox>
                    </div>

                    <!-- Medical Conditions -->
                    <div class="form-group">
                        <label for="<%= txtMedicalConditions.ClientID %>">Medical Conditions / Health Status</label>
                        <asp:TextBox ID="txtMedicalConditions" runat="server" CssClass="form-control" placeholder="e.g. None, Hypertension, Diabetes"></asp:TextBox>
                    </div>
                </div>
            </div>

            <div style="display:flex; gap: 1rem; align-items:center; margin-top: 1.5rem;">
                <asp:Button ID="btnUpdate" runat="server" Text="Save & Update Donor" CssClass="btn-primary" OnClick="btnUpdate_Click" />
                <a href="ViewDonors.aspx" style="color: var(--muted-text); text-decoration: none; font-weight: 500;">Cancel</a>
            </div>
        </asp:Panel>
    </div>
</asp:Content>
